def get_html(latest, benchmarks, audits, remediations, reports):
    return f"""<!DOCTYPE html>
<html>
<head>
    <title>OmniThread OS Enterprise Pro [AIOps Test Reports]</title>
...
<body>
    <div class="header">
        <h3 style="margin:0;">📈 OmniThread OS [Automated Test Report & MTTR]</h3>
        <p style="margin:5px 0 0 0; font-size:11px; color:#34d399;">Status: Enterprise Metrics & Recovery Audit Verified</p>
    </div>
    <div class="grid">
